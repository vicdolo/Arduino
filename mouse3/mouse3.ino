...
void loop() {
  ...
  compAngleX = 0.89 * (compAngleX + gyroXrate-78 * dt) + 0.07 * roll; // Calculate the angle using a Complimentary filter
  compAngleY = 0.89 * (compAngleY + gyroYrate+191 * dt) + 0.07 * pitch;
